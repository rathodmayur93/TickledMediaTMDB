...
class MovieListDelegate : MovieListData, UICollectionViewDelegate {
    
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("Selected Item Index \(indexPath.item)")
    }
}

class MovieListDelegateFlowLayout : MovieListData, UICollectionViewDelegateFlowLayout{
